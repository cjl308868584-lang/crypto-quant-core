...
class EvaluatorBuildTests(unittest.TestCase):
    ...
    def test_manifest_binds_complete_evaluator_file_set(self):
        ...
        self.assertEqual(semantic_versions, {(0, 70, 0)})
        self.assertEqual(crypto_quant.__version__, "0.70.0")
        self.assertEqual(manifest["package_version"], "0.70.0")
        self.assertEqual(manifest["manifest_version"], "1.64.0")
        ...
        self.assertEqual(build.manifest_version, "1.64.0")
